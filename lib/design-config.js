const DEFAULT_SIGNALS = [
  { label: "작업 공간", value: "악보 편집기" },
  { label: "접근 권한", value: "회원 + 관리자" },
  { label: "세션", value: "보호됨" },
];

const DEFAULT_HINTS = [
  "로그인 후 바로 편집기로 이동할 수 있습니다.",
  "관리자 계정은 운영 콘솔로 연결됩니다.",
];

export const DEFAULT_LANDING_PAGE_DESIGN = {
  brandName: "Simple Score",
  brandMeta: "안전한 악보 작업 공간",
  heroEyebrow: "Simple Score 접속",
  heroTitle: "악보 작업을 시작하는 순간부터 분위기가 달라지는 입구.",
  heroText:
    "정돈된 편집 환경, 분리된 관리자 접근, 조용한 보안 흐름을 한 화면에 담았습니다.",
  panelEyebrow: "계정 센터",
  panelTitle: "보안 계정 센터",
  panelStatusLabel: "로그인 필요",
  primaryActionLabel: "회원 로그인",
  secondaryActionLabel: "편집기 홈",
